                ...
                for (x, y) in shape:
                        ...
                        if diff_chx<10 and diff_chy<10:
                                ...
                                if diff_smile>10 and diff_smile<50 and j!=1:
                                        cv2.putText(frame,'Good Response', (50, 50),cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 255), 1)
                                        s=1
                                        cv2.imshow("selfie1", frame)

                                elif diff_up>3:
                                        cv2.putText(frame,'Neutral', (50, 50),cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 1)
                                        e=1
                                        ...
                                        cv2.putText(frame,'Bad response', (50, 50),cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 255), 1)
                                        le=1
...
df = pd.DataFrame({'lab':['Good Responds', 'Bad Response', 'Neutral Response'], 'val':[count_smile, count_be, count_eact]})
ax = df.plot.barh(x='lab', y='val',width=1.0,legend=False, figsize=(12,4))
fig = ax.get_figure()
fig.savefig("plot/myplot.png")
im1 = Image.open('sample/low.jpg')
im2 = Image.open('sample/kenny.png')
plot = Image.open('plot/myplot.png')
plot = plot.resize((650,400))
font = cv2.cv2.FONT_HERSHEY_SIMPLEX


new_img = im2.resize((400,400))
im1.paste(new_img, (985, 201))
im1.paste(plot, (100, 831))
im1.paste(plot, (900, 831))
im1.save("sample/life.png")

#im1.save('dasdsdsad.jpg
img = cv2.imread("sample/life.png")

cv2.putText(img,'Name:          V Prasanna ',(150*2,120*2+100), font, 1,(0,0,0),1,cv2.LINE_AA)
cv2.putText(img,'Age:            22 ',(150*2,140*2+100), font, 1,(0,0,0),1,cv2.LINE_AA)
cv2.putText(img,'Date :          16/03/2019 ',(150*2,160*2+100), font, 1,(0,0,0),1,cv2.LINE_AA)
cv2.putText(img,'Occupation:     Entertainer',(150*2,180*2+100), font, 1,(0,0,0),1,cv2.LINE_AA)
cv2.putText(img,'Video Duration: 22.44m ',(150*2,200*2+100), font, 1,(0,0,0),1,cv2.LINE_AA)

cv2.putText(img,'Visual Analysis: ',(203,713), font, 1,(0,0,0),1,cv2.LINE_AA)

cv2.putText(img,' Audio Analysis:  ',(1021,713), font, 1,(0,0,0),1,cv2.LINE_AA)
cv2.putText(img,' Video Overall Analysis:  '+ str(star),(217,1417), font, 1,(0,0,0),2,cv2.LINE_AA)
